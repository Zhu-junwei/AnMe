        ...
        renderMgrView() {
            ...
            mgrList.querySelectorAll('.acc-mgr-input').forEach(i => {
                ...
                i.onblur = () => {
                    ...
                    if (!val) {i.value = originalName;return;}
                    if (val !== originalName) {
