...
// ==/UserScript==
(() => {
  // <define:globalThis.__ANME_BUILD_META__>
  var define_globalThis_ANME_BUILD_META_default = { name: "AnMe", version: "10.0.12", author: "zjw", updatedAt: "2026-05-21" };

  // src/app/config.js
  var BUILD_META = define_globalThis_ANME_BUILD_META_default || globalThis.__ANME_EXTENSION_META__ || {};
  var CONST = {
    PREFIX: "acc_stable_",
  ...
  var I18N_DATA = {
    zh: { _name: "简体中文", nav_set: "设置", nav_notice: "使用声明", nav_about: "关于扩展", back_current_host: "返回当前网站账号", open_site: "打开网站", edit_site_name: "编辑站点名字", search_site: "搜索网站...", search_accounts: "搜索账号", close_search_accounts: "关闭搜索", search_accounts_placeholder: "搜索当前网站账号...", account_settings: "账号设置", site_name: "站点名称", account_name: "账号名称", save_changes: "保存修改", btn_delete_account: "删除该账号", danger_zone: "危险操作", rename_conflict: "该名称已存在，请换一个名称。", confirm_delete: "确定要删除该账号记录吗？", placeholder_site_name: "给当前网站命名...", placeholder_name: "给新账号命名...", tip_help: "切换登录失败？尝试勾选 LocalStorage 和 SessionStorage。", tip_lock: "为保证正常读取 Cookie，请在浏览器扩展权限中允许 AnMe 访问 Cookie", btn_save: "保存当前账号", confirm_overwrite: "⚠️ 该名称已存在，确定要覆盖原有记录吗？", btn_clean: "切换新环境 (清空本站痕迹)", save_empty_err: "⚠️ 没有检测到可保存的数据", copy_account_name: "复制账号名", copy_failed: "复制失败，请手动复制。", toast_saved: "账号已保存", toast_renamed: "账号名称已更新", toast_deleted: "账号已删除", toast_copied: "账号名已复制", toast_site_name_updated: "站点名称已更新", set_fab_mode: "悬浮球显示模式", fab_auto: "智能", fab_show: "常驻", fab_hide: "隐藏", fab_auto_title: "有账号记录时自动显示，无记录时隐藏", fab_show_title: "始终显示悬浮球", fab_hide_title: "平时不显示，仅能通过菜单唤起", set_lang: "语言设置 / Language", set_host_display_mode: "站点列表显示模式", host_display_mode_site_name: "站点名字", host_display_mode_domain: "域名", set_backup: "数据备份与还原", btn_exp_curr: "导出当前网站数据", btn_exp_all: "导出全部网站数据", btn_imp: "导入备份文件", donate: "支持作者", btn_clear_all: "清空脚本所有数据 (慎用)", notice_title: "《使用声明与免责条款》", back: "← 返回上一级", no_data: "🍃 暂无账号记录", confirm_clean: "确定清空当前网站所有痕迹并开启新环境？", confirm_clear_all: "⚠️ 警告：这将删除本扩展保存的所有网站的所有账号数据！且无法恢复！", import_ok: "✅ 成功导入/更新 {count} 个账号！", import_err: "❌ 导入失败：文件格式错误", export_err: "⚠️ 没有可导出的数据", menu_open: "🚀 开启账号管理", dlg_ok: "确定", dlg_cancel: "取消", about_desc: "通用多网站多账号切换器", notice_content: `<h4>1. 扩展功能说明</h4><p>本扩展通过浏览器扩展存储 API，将当前网站的 Cookie、LocalStorage 和 SessionStorage 进行快照保存。切换账号时，扩展会清空当前痕迹并还原选中的快照数据。</p><h4>2. 数据存储与联网说明</h4><p>账号数据默认存储在浏览器扩展的本地存储中。扩展默认不会主动上传数据；只有在您手动配置并使用 WebDAV 同步功能时，才会访问您指定的远程服务。</p><h4>3. 风险提示</h4><p>请勿在公共电脑或不可信设备上保存重要账号。</p><h4>4. 免责声明</h4><p>本扩展仅供学习交流使用。因使用本扩展导致的账号被封禁、数据泄露或任何形式的损失，作者不承担任何法律责任。</p>` },
    en: { _name: "English", nav_set: "Settings", nav_notice: "Disclaimer", nav_about: "About Extension", back_current_host: "Back to current site", open_site: "Open site", edit_site_name: "Edit site name", search_site: "Search sites...", search_accounts: "Search accounts", close_search_accounts: "Close search", search_accounts_placeholder: "Search accounts on this site...", account_settings: "Account Settings", site_name: "Site Name", account_name: "Account Name", save_changes: "Save Changes", btn_delete_account: "Delete Account", danger_zone: "Danger Zone", rename_conflict: "This name already exists. Please choose another one.", confirm_delete: "Are you sure you want to delete this account?", placeholder_site_name: "Name this site...", placeholder_name: "Name this account...", tip_help: "Switch failed? Try checking LocalStorage/SessionStorage.", tip_lock: "To ensure cookies can be read correctly, grant AnMe cookie access in your browser extension permissions.", btn_save: "Save Current", confirm_overwrite: "⚠️ Name already exists. Do you want to overwrite it?", btn_clean: "Switch to a new environment (clear all data for this site)", save_empty_err: "⚠️ No data detected to save", copy_account_name: "Copy account name", copy_failed: "Copy failed. Please copy it manually.", toast_saved: "Account saved", toast_renamed: "Account name updated", toast_deleted: "Account deleted", toast_copied: "Account name copied", toast_site_name_updated: "Site name updated", set_fab_mode: "Float Button Mode", fab_auto: "Auto", fab_show: "Show", fab_hide: "Hide", fab_auto_title: "Automatically show when accounts exist, hide when none", fab_show_title: "Always show the floating button", fab_hide_title: "Hidden by default, can only be activated via the menu", set_lang: "语言设置 / Language", set_host_display_mode: "Site List Display", host_display_mode_site_name: "Site Name", host_display_mode_domain: "Domain", set_backup: "Backup & Restore", btn_exp_curr: "Export Current Site", btn_exp_all: "Export All Sites Data", btn_imp: "Import Backup", donate: "Buy me a coffee", btn_clear_all: "Clear all extension data (use with caution)", notice_title: "Disclaimer & Terms", back: "← Back", no_data: "🍃 No accounts", confirm_clean: "Are you sure you want to clear all traces of the current website and start a new environment?", confirm_clear_all: "⚠️ Warning: This will delete all account data for all websites saved by this extension, and cannot be undone!", import_ok: "✅ Successfully imported/updated {count} account(s)!", import_err: "❌ Invalid format", export_err: "⚠️ No data", menu_open: "🚀 Open Manager", dlg_ok: "OK", dlg_cancel: "Cancel", about_desc: "Universal Multi-Site Account Switcher", notice_content: `<h4>1. Extension Functionality</h4><p>This extension stores snapshots of the current website's Cookies, LocalStorage, and SessionStorage in browser extension storage. When switching accounts, it clears current session data and restores the selected snapshot.</p><h4>2. Data Storage & Network Access</h4><p>Account data is stored locally in browser extension storage by default. The extension does not upload data unless you explicitly configure and use WebDAV sync.</p><h4>3. Risk Warning</h4><p>Please avoid saving sensitive accounts on public or untrusted devices.</p><h4>4. Disclaimer</h4><p>This extension is intended for educational and exchange purposes only. The author is not responsible for account bans, data breaches, or any loss resulting from use.</p>` },
    es: { _name: "Español", nav_set: "Configuración", nav_notice: "Aviso legal", nav_about: "Acerca de la extensión", back_current_host: "Volver al sitio actual", open_site: "Abrir sitio", edit_site_name: "Editar nombre del sitio", search_site: "Buscar sitios...", search_accounts: "Buscar cuentas", close_search_accounts: "Cerrar búsqueda", search_accounts_placeholder: "Buscar cuentas en este sitio...", account_settings: "Configuración de la cuenta", site_name: "Nombre del sitio", account_name: "Nombre de la cuenta", save_changes: "Guardar cambios", btn_delete_account: "Eliminar cuenta", danger_zone: "Zona peligrosa", rename_conflict: "Ese nombre ya existe. Usa otro nombre.", confirm_delete: "¿Estás seguro de que deseas eliminar esta cuenta?", placeholder_site_name: "Nombre para este sitio...", placeholder_name: "Nombre para esta cuenta...", tip_help: "¿Falló el cambio de cuenta? Intenta marcar LocalStorage y SessionStorage.", tip_lock: "Para leer cookies correctamente, concede a AnMe acceso a cookies en los permisos de la extensión del navegador.", btn_save: "Guardar cuenta actual", confirm_overwrite: "⚠️ El nombre ya existe. ¿Deseas sobrescribirlo?", btn_clean: "Cambiar a un nuevo entorno (borrar datos del sitio)", save_empty_err: "⚠️ No se detectaron datos para guardar", copy_account_name: "Copiar nombre de la cuenta", copy_failed: "No se pudo copiar. Cópialo manualmente.", toast_saved: "Cuenta guardada", toast_renamed: "Nombre de cuenta actualizado", toast_deleted: "Cuenta eliminada", toast_copied: "Nombre de cuenta copiado", toast_site_name_updated: "Nombre del sitio actualizado", set_fab_mode: "Modo del botón flotante", fab_auto: "Automático", fab_show: "Siempre visible", fab_hide: "Oculto", fab_auto_title: "Se muestra automáticamente cuando hay cuentas guardadas; se oculta si no hay ninguna", fab_show_title: "El botón flotante se muestra siempre", fab_hide_title: "Oculto por defecto, solo accesible desde el menú", set_lang: "Idioma / Language", set_host_display_mode: "Modo de lista de sitios", host_display_mode_site_name: "Nombre del sitio", host_display_mode_domain: "Dominio", set_backup: "Copia de seguridad y restauración", btn_exp_curr: "Exportar datos del sitio actual", btn_exp_all: "Exportar todos los datos de los sitios", btn_imp: "Importar archivo de respaldo", donate: "Apoyar al autor", btn_clear_all: "Borrar todos los datos de la extensión (usar con precaución)", notice_title: "Términos de uso y descargo de responsabilidad", back: "← Volver", no_data: "🍃 No hay cuentas", confirm_clean: "¿Seguro que deseas borrar todos los rastros del sitio actual y comenzar un nuevo entorno?", confirm_clear_all: "⚠️ Advertencia: Esto eliminará todos los datos de cuentas guardados por esta extensión. ¡Esta acción no se puede deshacer!", import_ok: "✅ Se importaron/actualizaron correctamente {count} cuenta(s)", import_err: "❌ Error de importación: formato de archivo inválido", export_err: "⚠️ No hay datos para exportar", menu_open: "🚀 Abrir gestor de cuentas", dlg_ok: "Aceptar", dlg_cancel: "Cancelar", about_desc: "Conmutador universal de múltiples cuentas para múltiples sitios", notice_content: `<h4>1. Funcionalidad de la extensión</h4><p>Esta extensión guarda instantáneas de Cookies, LocalStorage y SessionStorage del sitio actual en el almacenamiento de la extensión del navegador. Al cambiar de cuenta, borra los datos actuales y restaura la instantánea seleccionada.</p><h4>2. Almacenamiento y red</h4><p>Los datos se almacenan localmente de forma predeterminada. La extensión no sube datos salvo que configures y uses explícitamente WebDAV.</p><h4>3. Riesgo</h4><p>Evita guardar cuentas sensibles en equipos públicos o no confiables.</p><h4>4. Descargo de responsabilidad</h4><p>Esta extensión se proporciona únicamente con fines educativos y de intercambio. El autor no asume responsabilidad por bloqueos, filtraciones o pérdidas derivadas del uso.</p>` }
  };
  ...
  // src/app/runtime.js
  var EXTENSION_MESSAGE_TYPE = "ANME_EXTENSION_BRIDGE";
  ...
  function installCookieBridge() {
    globalThis.GM_cookie = {
      list(details = {}, callback) {
        ...
        }).then((cookies) => callback?.(cookies || [])).catch((error) => {
      ...
      set(details = {}, callback) {
        ...
        }).then((cookie) => callback?.(cookie)).catch((error) => {
  ...
  async function installExtensionRuntimeIfNeeded() {
